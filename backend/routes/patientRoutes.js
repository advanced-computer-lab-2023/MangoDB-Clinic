...
router.get("/filter_prescription/:patientId",protectPatient, filterPrescription);

//select a prescription from my list of prescriptions
router.get("/select_prescription/:prescriptionId",protectPatient,  selectPrescription);
...
router.get("/view_subscribed_health_package/:id",protectPatient, viewSubscribedhealthPackage);
...
router.put("/add_documents/:id",protectPatient, upload.array("document"), addDocuments);

router.delete("/delete_document/:patientId/:documentId",protectPatient, deleteDocument);

router.put("/link_family_member/:id",protectPatient, linkFamilyMember);

router.put(
  "/subscribe_to_health_package/:patientId/:packageId",protectPatient,
  subscribeToHealthPackage
);

// utils
router.post("/add_prescription/:doctorId/:patientId",protectPatient, addPrescription);
router.post("/add_appointment/:doctorId/:patientId",protectPatient, addAppointment);
router.get("/get_specialities", getSpecialities);
router.get("/getAvailableAppointments",getAvailableAppointments)


router.get("/get_available_appointments/:id",protectPatient, getAvailableAppointments);
