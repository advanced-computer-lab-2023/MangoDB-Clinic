...
export default function SuccessfulPackagePayment() {
  ...
  return ( 
    ...
    <div>
      ...
      {!success && !error && <div>Loading...</div>} {error && <div>{error} </div> } 
      {success && 
      <div>
            <h1>Your payment has been successful. You will be redirected to the patient dashboard in a few seconds, or you can skip the wait and
